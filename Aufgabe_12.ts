...
// Array aus Aufgabe 9.4
        var artikel : Artikel[] =  [racoon, blueEye, woman, lakeside, twoFish, nightsky, girlOne, monkey, inLove, camelion, girlTwo, faceOne, faceTwo, girlThree, autumnPath, justBeYou, zebraStreak, feathers, giraffe, babyDeer, elephant];
...
// Aufgabe 12.1
    ...
    // Aufgabe 12.2 - Preisfilter 
         function filterByPrize(prize1 : number, prize2 : number) : void {
    ...
    // Aufgabe 12.3 - Filter für Künstler
          function filterByKuenstler(kuenstler : string) : void {
          ...
          function filterBySale(special1 : string, special2 : string) : void {
